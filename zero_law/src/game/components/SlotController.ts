...
export class SlotController {
	...
	updateBetAmount(betAmount: number): void {
		...
		// Always keep the underlying base bet in sync with the selected bet.
		// (The +25% "enhanced bet" is a display-only multiplier and is NOT stored here.)
		this.baseBetAmount = betAmount;

		// Only reset amplify/enhanced bet state when the bet change is truly "external".
		// Autoplay bet changes intentionally preserve enhance bet when it was already enabled.

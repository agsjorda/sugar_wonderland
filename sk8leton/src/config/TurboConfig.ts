...
export class TurboConfig {
    ...
    public static readonly TURBO_SPEED_MULTIPLIER: number = .8;
    
    // Turbo delay multiplier for spin timing
    public static readonly TURBO_DELAY_MULTIPLIER: number = .8;
    
    // Turbo duration multiplier for animations
    public static readonly TURBO_DURATION_MULTIPLIER: number = .8;
    
    // Winline animation speed multiplier (4x faster = 4.0x speed)
    public static readonly WINLINE_ANIMATION_SPEED_MULTIPLIER: number = 2.0;

...
// 
        ...
        switch (winType) {
            case 'BigWin':
                animationName = 'big_WF_win';
                animationName2 = 'big_WF_idle'; 
                break;

            case 'EpicWin':
                animationName = 'epic_WF_win';
                animationName2 = 'epic_WF_idle';
                break;

            case 'MegaWin':
                animationName = 'mega_WF_win';
                animationName2 = 'mega_WF_idle';
                break;

            case 'SuperWin':
                animationName = 'super_WF_win';
                animationName2 = 'super_WF_idle';
                break;

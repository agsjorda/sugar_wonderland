...
export class Slot {
    ...
    static readonly SCATTER_SIZE: number = 1.025;
    static readonly LOW_PAYING_SYMBOL_SIZE: number = 1.08;
    static readonly HIGH_PAYING_SYMBOL_SIZE: number = 1.75;
    static readonly BOMB_SIZE_X: number = 1.25;
    static readonly BOMB_SIZE_Y: number = 1.65;

        ...
        try {
            ...
            if (this.gameData.debugged < -99) {
                if(this.gameData.debugged == -100){ // 123456789.01 win = wtf ; fake API
                    ...
                    const data = {"playerId":"2","bet":"1","slot":{"area":[[8,9,9,7,7],[2,6,6,9,9],[2,2,7,7,9],[8,7,7,3,3],[9,7,7,5,5],[9,9,8,8,6]],"totalWin":1.75,"tumbles":[{"symbols":{"in":[[6,6,7,7],[7,7],[7,7,4],[7,8],[7,7,9],[7,7]],"out":[{"symbol":9,"count":8,"win":0.25},{"symbol":7,"count":11,"win":0.5}]},"win":0.75},{"symbols":{"in":[[6,6],[8,8],[6,8],[2],[2,2],[2,2]],"out":[{"symbol":7,"count":10,"win":1}]},"win":1},{"symbols":{"in":[[1,1,2,2,3],[2,2,3,3,4],[6,6,5,5],[8,8,8],[9,7],[9,7,7,7,7]],"out":[{"symbol":6,"count":8,"win":1},{"symbol":8,"count":8,"win":1},{"symbol":2,"count":8,"win":1}]},"win":1}],"freeSpin":[]}};
                    return data;
                }
                else if (this.gameData.debugged == -108){ // 15 free spins
                    const data = {"playerId":"2","bet":"40","slot":{"area":[[8,8,0,9,9],[9,5,5,7,7],[9,9,7,7,6],[9,6,6,8,8],[4,4,9,9,0],[6,6,7,9,3]],"totalWin":0.25,"tumbles":[{"symbols":{"in":[[7,9],[8],[9,9],[6],[5,5],[5]],"out":[{"symbol":9,"count":9,"win":0.25}]},"win":0.25}],"freeSpin":{"multiplierValue":0,"items":[]}}};
                    return data;
                }

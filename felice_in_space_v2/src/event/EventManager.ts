...
// Tumble-specific event data
export interface TumbleWinProgressEventData {
  cumulativeWin: number;
}

export interface TumbleSequenceDoneEventData {
  totalWin: number;
}
...
export interface MultiplierArrivedEventData {
  spinTotal: number;
  weight: number;
}

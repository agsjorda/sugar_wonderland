...
export enum GameEventType {
  ...
  // Symbols / spin processing pipeline (async phases)
  SYMBOLS_DROP_REELS_COMPLETE = 'SYMBOLS_DROP_REELS_COMPLETE',
  SYMBOLS_TUMBLES_COMPLETE = 'SYMBOLS_TUMBLES_COMPLETE',
  SYMBOLS_MULTIPLIER_ANIMATIONS_COMPLETE = 'SYMBOLS_MULTIPLIER_ANIMATIONS_COMPLETE',
  SYMBOLS_SCATTER_ANIMATIONS_COMPLETE = 'SYMBOLS_SCATTER_ANIMATIONS_COMPLETE',
  SYMBOLS_BONUS_RETRIGGER_COMPLETE = 'SYMBOLS_BONUS_RETRIGGER_COMPLETE',

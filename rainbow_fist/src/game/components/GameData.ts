...
export class GameData {
	...
	public bigWinThreshold: number = 1;
	public megaWinThreshold: number = 1;
...
export function setSpeed(data: GameData, DELAY_BETWEEN_SPINS: number) {
    ...
    data.dropReelsDelay = DELAY_BETWEEN_SPINS * 0.25 * DROP_REEL_START_INTERVAL_RATIO;
	data.dropReelsDuration = DELAY_BETWEEN_SPINS * 1 * DROP_RESET_TIME_MULTIPLIER;
}

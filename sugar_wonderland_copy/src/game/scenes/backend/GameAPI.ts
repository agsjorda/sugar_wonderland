    ...
    public async doSpin(bet: number, isBuyFs:boolean, isEnhancedBet:boolean): Promise<any> {
        ...
        try {
            ...
            if (this.gameData.debugged < -99) {
                ...
                else if (this.gameData.debugged == -107){ // tumble 2 symbols, no free spins total win 30
                    const data = {"playerId":"2","bet":"0.2","slot":{"area":[[4,4,6,6,9],[2,8,8,9,9],[4,4,7,7,9],[8,8,9,9,4],[8,5,5,9,9],[9,9,7,7,9]],"totalWin":30,"tumbles":[{"symbols":{"in":[[5],[5,5],[9],[6,6],[5,7],[9,1,1]],"out":[{"symbol":9,"count":11,"win":30}]},"win":30}],"freeSpin":{"multiplierValue":0,"items":[]}}};
                    return data;
                }
